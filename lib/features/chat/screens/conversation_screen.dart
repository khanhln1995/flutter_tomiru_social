...
// import 'package:tomiru_social_flutter/features/chat/widgets/web_chat_view_widget.dart';
    ...
    return GetBuilder<ChatController>(builder: (chatController) {
      ...
      return Scaffold(
            ...
            ? (chatController.conversationModel != null &&
                ...
                ? FloatingActionButton(
                    ...
                    child: CustomImageWidget(
                      image:
                          '${Get.find<SplashController>().configModel!.baseUrls!.businessLogoUrl}/${Get.find<SplashController>().configModel!.favIcon}',
                    ),
                  )
                : null
            : null,
        body:
            ...
            //     :
            Column(children: [
          (Get.find<AuthController>().isLoggedIn() && conversation != null)
              ? Center(
                  child: Container(
                  ...
                  ? (conversation != null)
                      ? RefreshIndicator(
                          ...
                          child: CustomScrollView(
                              ...
                              slivers: [
                                SliverToBoxAdapter(
                                    child: chatController.conversationModel !=
                                            null
                                        ? Padding(
                                ...
                                SliverToBoxAdapter(
                                  child: conversation.conversations != null
                                      ? conversation.conversations!.isNotEmpty
                                          ? conversationCart(
