...
class _FollowingState extends State<Following> {
  ...
  final List<Member> members = [
    const Member(name: 'Hội Saler Sun Tower', avatar: 'assets/images/Ellipse 10.png', sub:"Truy cập cuối: 2 năm trước"),
    const Member(
        name: 'Hội Saler Sun Tower', avatar: 'assets/images/Ellipse 10 (1).png',
        sub: "Truy cập cuối: 2 năm trước"),
    const Member(
        name: 'Hội Saler Sun Tower', avatar: 'assets/images/Ellipse 10 (2).png',
        sub: "Truy cập cuối: 2 năm trước"),
    const Member(
        name: 'Hội Saler Sun Tower', avatar: 'assets/images/Ellipse 10 (3).png',
        sub: "Truy cập cuối: 2 năm trước"),
    const Member(
        name: 'Hội Saler Sun Tower', avatar: 'assets/images/Ellipse 10 (4).png',
        sub: "Truy cập cuối: 2 năm trước"),
    const Member(name: 'Hội Saler Sun Tower', avatar: 'assets/images/Ellipse 11.png',
        sub: "Truy cập cuối: 2 năm trước"),
    const Member(name: 'Hội Saler Sun Tower', avatar: 'assets/images/Ellipse 12.png',
        sub: "Truy cập cuối: 2 năm trước"),
    const Member(name: 'Hội Saler Sun Tower', avatar: 'assets/images/Ellipse 12.png',
        sub: "Truy cập cuối: 2 năm trước"),
    const Member(name: 'Hội Saler Sun Tower', avatar: 'assets/images/Ellipse 12.png',
                ...
                ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    return ListTile(
                      ...
                      subtitle:Text(
                        members[index].sub,style: TextStyle(color: Colors.grey[600]),) ,
                      trailing: ElevatedButton(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text(
                              isFollow[index] == true ? "Bỏ theo dõi" : "Theo dõi",
                              style: TextStyle(
                                fontSize: 14,
